#include "balltrajectory/HelloWorldScene.h"

USING_NS_CC;
using namespace balltrajectory;
...
bool HelloWorld::init()
{
    ...
    ballY = 200;  
    powerMultiplier = 10;  
    ball =Sprite::create("balltrajectory/ball.png");
    ...
    for (int i = 1 ; i <= 31; i++){
        points[i] =CCSprite::create("balltrajectory/dot.png");
