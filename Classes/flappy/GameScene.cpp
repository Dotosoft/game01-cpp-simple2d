...
bool GameScene::init()
{
	...
	scoreLabel = Label::createWithTTF( tempScore->getCString(), "flappy/fonts/Marker Felt.ttf", visibleSize.height * SCORE_FONT_SIZE );
...
bool GameScene::onContactBegin( cocos2d::PhysicsContact &contact )
{
	...
	{
		CocosDenshion::SimpleAudioEngine::getInstance()->playEffect( "flappy/Sounds/Hit.mp3" );
	...
	{
		CocosDenshion::SimpleAudioEngine::getInstance()->playEffect( "flappy/Sounds/Point.mp3" );
		score++;
