...
bool MainMenuScene::init()
{
	...
	auto titleSprite = Sprite::create( "flappy/Title.png" );
	titleSprite->setPosition( Point( visibleSize.width / 2 + origin.x, visibleSize.height - titleSprite->getContentSize().height ) );
    
	this->addChild( titleSprite );

    auto playItem = MenuItemImage::create( "flappy/Play Button.png", "flappy/Play Button Clicked.png", CC_CALLBACK_1( MainMenuScene::GoToGameScene, this ) );
