...
void Pipe::SpawnPipe( cocos2d::Layer *layer )
{
	...
	auto topPipe = Sprite::create( "flappy/Pipe.png" );
	auto bottomPipe = Sprite::create( "flappy/Pipe.png" );
	...
	bottomPipe->setPosition( Point( topPipe->getPositionX(), topPipePosition - (Sprite::create("flappy/Ball.png")->getContentSize().height * PIPE_GAP ) - topPipe->getContentSize().height ) );
	...
	auto pointBody = PhysicsBody::createBox( Size( 1, Sprite::create( "flappy/Ball.png" )->getContentSize( ).height * PIPE_GAP ) );
	...
	pointNode->setPosition( Point(topPipe->getPositionX( ), topPipe->getPositionY( ) - ( topPipe->getContentSize( ).height / 2 ) - ( ( Sprite::create( "flappy/Ball.png" )->getContentSize( ).height * PIPE_GAP ) / 2 ) ) );
